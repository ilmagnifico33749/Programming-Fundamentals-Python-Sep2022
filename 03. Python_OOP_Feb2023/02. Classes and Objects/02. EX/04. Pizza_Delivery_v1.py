class PizzaDelivery:
    ...
    def make_order(self):
        ...
        ingredients_quantity = ', '.join([f"{ingredient}: {self.ingredients[ingredient]}" for ingredient in self.ingredients])
